...
* **Sincronización Offline Delegada:** Todo el manejo de guardado sin conexión y sincronización es responsabilidad absoluta del **frontend**. El backend no requiere crear endpoints adicionales (`/sync`), ya que el frontend se encargará de encolar las peticiones pendientes e invocar los endpoints regulares uno a uno una vez recuperada la conexión a internet.
